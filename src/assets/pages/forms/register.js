        ...
        <div className="right">
          <div className="requirements">
            ...
            <div className="description">
              ...
              <ol>
                <li>
                  Get application form at the SSD Office front desk and fill
                  out.
                </li>
                <li>
                  Photocopy of Care Card or Voter's ID/Verification (if
                ...
                <li>
                  Photocopy ITR or Photocopy of 1 month pay slip (if employed)
                </li>
                <li>Certificate of Non-Filling of ITR (not employed)</li>
                <li>
                  Affidavit of Being a Solo Parent (Legal Office - 3F Annex
                  Bldg., City Hall)
                </li>
                <li>
                  Photo Copy of birth Certicate of Child/Children, 22 years old
                  and below
                </li>
                <li>Photo Copy of PWD ID (for PWD Child/Children)</li>
                <li>
                  Photo Copy of Spouse Death Certificate(if widow/widower)
                </li>
            ...
            <div className="description">
              ...
              <ol>
                ...
                <li>Affidavit of Non-filing of ITR (not employed)</li>
